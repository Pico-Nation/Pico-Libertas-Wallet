      ...
      >
        {(!confirming && !ipfsing) ? (
            <Segment basic clearing>
              ...
              <Message
                content="Proxies play an important role in the PICO.IO blockchain by being delegated the responsibility of determining which Block Producers should be in the Top 21. Submitting your information in this form will register you on chain and allow voters to research your proxy and determine whether or not they would like to proxy their votes to you. For users that are trusting you with their votes, it is expected that you vote responsibly!"
                warning
              />
              <FormMessageError
                errors={
