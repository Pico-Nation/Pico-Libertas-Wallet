          ...
          (t) => (
            <Segment loading={!(account)}>
              ...
              >
                ...
                { (settings.blockchain.tokenSymbol === 'PICO' && showSponsor) ?
                <Message icon info>
                <Icon name='thumbs outline up' />
                <Message.Content>
                <Message.Header>
                  Help us make Pico better
                </Message.Header>
                  Please vote for&nbsp;<b><a onClick={() => this.openLink("https://telos.miami")} role="link" style={{ cursor: 'pointer' }}>telosmiamibp</a></b>&nbsp;to help support Pico development and 
                ...
                <Message.Header>
                  ...
                  Please vote for&nbsp;<b><a onClick={() => this.openLink("https://zenblocks.io")} role="link" style={{ cursor: 'pointer' }}>zenblockswax</a></b>&nbsp;to help support our development for great tools such as Pico.
                  </Message.Content>
                </Message>
                :''}
