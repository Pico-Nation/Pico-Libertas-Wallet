...
import GlobalSettingsPicoToken from './Global/Settings/PicoToken';
      ...
      <React.Fragment>
        ...
        <Segment attached padded="very">
          ...
          <Form>
            ...
            <Form.Field>
              <label>{t('tools_change_use_pico_token')}</label>
              <GlobalSettingsPicoToken
                actions={actions}
                defaultValue={settings.usePICOtoken}
                selection
              />
            </Form.Field>
            <Form.Field>
