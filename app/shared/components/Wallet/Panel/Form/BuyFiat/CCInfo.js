  ...
  render() {
    ...
    return (
      <Form>
        ...
        <Message
          content="Important Note: Pico does NOT store your information. It simply collects and securely transmits your payment information to Carbon.Money for processing."
          icon="info circle"
          info
        />
