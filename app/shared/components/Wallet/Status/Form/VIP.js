...
class WalletStatusVIPForm extends Component<Props> {
  ...
  render() {
    ...
    return (
      <Segment>
        <Message positive>
          Your current PICO consumption is: <b>{profile.usage}</b>
        </Message>
        <Table celled padded>
        <Table.Header>
          <Table.Row>
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell singleLine>100 - 249 PICO</Table.Cell>
            <Table.Cell>
          ...
          <Table.Row>
            ...
            <Table.Cell singleLine>250 - 499 PICO</Table.Cell>
            <Table.Cell>
            Obtain Level 2 after consuming between 250 - 499 tokens. This unlocks all social features in Pico.
            </Table.Cell>
          ...
          <Table.Row>
            ...
            <Table.Cell singleLine>500 - 999 PICO</Table.Cell>
            <Table.Cell>
          ...
          <Table.Row>
            ...
            <Table.Cell singleLine>1,000 - 9,999 PICO</Table.Cell>
            <Table.Cell>
          ...
          <Table.Row>
            ...
            <Table.Cell singleLine>10,000+ PICO</Table.Cell>
            <Table.Cell>
