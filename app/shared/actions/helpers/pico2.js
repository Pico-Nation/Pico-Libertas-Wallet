...
import { Api, Rpc } from 'picojs2';
import JsSignatureProvider from 'picojs2/dist/picojs2-jssig';

export default function pico2(connection, signing = true, payforsig = false) {
