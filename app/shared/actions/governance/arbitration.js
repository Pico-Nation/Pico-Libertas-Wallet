...
const defaultContract = 'picoio.arb';
...
export function getArbitrators(scope = 'picoio.arb', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
...
export function getLeaderBoards(scope = 'picoio.trail', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
