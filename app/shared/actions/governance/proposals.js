...
const defaultContract = 'picoio.saving';
...
export function getProposals(scope = 'picoio.trail', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
...
export function getBallots(scope = 'picoio.trail', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
...
export function getProposalSubmissions(scope = 'picoio.saving', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
...
export function getRatifySubmissions(scope = 'picoio.amend', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
...
export function getRatifyDocuments(scope = 'picoio.amend', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
