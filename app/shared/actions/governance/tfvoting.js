...
export function getTFConfig() {
  return (dispatch: () => void, getState) => {
    ...
    pico(connection).getTableRows(true, defaultContract, defaultContract, 'config').then((results) => dispatch({
...
export function getTFVoterBalances(scope = 'picoio.trail', previous = false) {
  return (dispatch: () => void, getState) => {
    dispatch({
