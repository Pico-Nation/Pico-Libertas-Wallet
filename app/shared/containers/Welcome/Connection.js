  ...
  componentDidMount() {
    ...
    if (settings.skipImport) {
      if (settings.blockchainSelected) {
        ...
        // manually set to PICO testnet by default
      ...
      serverInstructions = (
        <Message
          ...
          content={(
            <p>
              <a
                onClick={() => this.openLink('https://github.com/Telos-Foundation/Pico/blob/master/nodes.md')}
                onKeyPress={() => this.openLink('https://github.com/Telos-Foundation/Pico/blob/master/nodes.md')}
                role="link"
