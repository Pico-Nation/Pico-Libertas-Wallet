...
*/
    ...
    //                 case Blockchains.PICOIO: symbol = 'PICO';
    //             }
    //         }
    ...
    //             // TODO: Support fork chains
    //             switch(network.blockchain){
    //                 case Blockchains.PICOIO: contract = 'picoio.token';
    //             }
    //         }

    //         request.payload.memo = network.blockchain === 'pico'
    ...
    static async [Actions.REQUEST_SIGNATURE](request){
        return new Promise(async resolve => {
            ...
            switch(blockchain){
                ...
                case Blockchains.PICOIO: payload.messages = await plugin.requestParser(payload, network); break;
