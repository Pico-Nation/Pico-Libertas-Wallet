...
const knownTypes = {
  "picoio.newaccount": true,
  "picoio.buyrambytes": true,
  "picoio.buyram": true,
  "picoio.sellram": true,
  "picoio.delegatebw": { "transform": (index, style, msg, _translated) => {
    const translated = {
  ...
  "picoio.undelegatebw": { "transform": (index, style, msg, _translated) => {
    const translated = {
      params: _translated.params,
      sentence: _translated.sentence
    }
  ...
  "picoio.regproducer": true,
  "picoio.unregprod": true,
  "picoio.voteproducer": { "transform": (index, style, msg, _translated) => {
    const translated = {
      params: _translated.params,
      sentence: _translated.sentence
    }
